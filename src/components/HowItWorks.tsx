...
const HowItWorks = () => {
  ...
  return <section className="py-20 px-4 bg-gradient-to-r from-blue-50 to-purple-50">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {steps.map((step, index) => <div key={index} className="relative">
              {/* Connector Line */}
              {index < steps.length - 1 && <div className="hidden md:block absolute top-24 left-full w-full h-1 bg-gradient-to-r from-gray-200 to-gray-300 z-0 transform translate-x-4"></div>}
